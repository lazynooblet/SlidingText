...
export default class myClock {
    ...
    doTick(event) {
        ...
        const currentMinuteParts = util.toLower(NumberToText.getMinutes(minuteInt)).split(' ');
        const nextMinuteParts = util.toLower(NumberToText.getMinutes(nextMinutes)).split(' ');
